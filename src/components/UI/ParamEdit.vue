<template>
  <div class="settings-section__current-param">
    <div v-if="visible">
      <span v-if="paramText" class="settings-section__current-param-text">{{paramText}}</span>
      <span class="settings-section__current-param-edit" @click="changeVisible">
      <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg" class="icon settings-section__current-param-edit-icon">
